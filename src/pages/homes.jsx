...
export default function Homes() {
  ...
  <Carousel
    ...
    style={{ maxWidth: '100%', background: 'none' }} // Assurez-vous qu'il n'y a pas d'image de fond
  >
        ...
        <Carousel.Item key={book.id} onClick={() => handlePress(book.id)}>
          <div className="d-flex justify-content-center" style={{ background: 'none' }}>
            <img
              ...
              style={{
                width: '100%',
                height: '500px', // Hauteur ajustée pour les grandes images
  ...
  {books
    ...
    .map(item => (
      ...
      <button onClick={handleButtonClick} style={{ alignItems: 'center', flex: 1, border: 'none' }}>
        <Bookmark size={24} />
